      ...
      <main className="pt-28 pb-16 flex-1">
        ...
        <section id="overview" className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center mb-6">
            <a
              href="#launch-offer"
              className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full bg-[#000000] hover:bg-[#222226] text-white font-semibold text-sm transition-all shadow-xl shadow-black/10 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
