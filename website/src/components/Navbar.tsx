  ...
  return (
    <header className="top-notch-header">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <a
          href="#launch-offer"
          className="px-4 py-1.5 text-xs font-semibold rounded-full bg-white text-black hover:bg-zinc-100 transition-colors shadow-sm flex items-center gap-1.5 cursor-pointer"
        >
