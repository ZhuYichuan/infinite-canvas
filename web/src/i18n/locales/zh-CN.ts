export default {
    ...
    canvas: {
        ...
        resetView: "重置视图",
        zoom: "放大/缩小画布",
        agentConnected: "WorkBuddy 已连接",
        agentConnecting: "WorkBuddy {{activity}}",
        agentDisconnected: "WorkBuddy 未连接",
        connecting: "连接中",
        openAgent: "打开 WorkBuddy 助理面板",
        ...
        node: {
            node: "节点",
            untitled: "未命名节点", renameHint: "双击修改节点名称", group: "组", nodeCount: "{{count}} 个节点", generating: "生成中", failed: "生成失败", retry: "重试", resumePolling: "重新查询", missingPlugin: "缺少插件", missingPluginDescription: "节点类型“{{type}}”的插件未安装或未启用", generateImage: "用文本生图", generate: "生图", editText: "双击编辑文字", emptyImage: "空图片节点", emptyVideo: "空视频节点", emptyAudio: "空音频节点", audio: "音频", batchExpanded: "图片组已展开", batchCollapsed: "图片组已收起", textBatchExpanded: "备选文本已展开", textBatchCollapsed: "备选文本已收起", createCopy: "创建副本", setPrimary: "设为主图", setPrimaryText: "设为主文本", groupSelection: "编组", ungroup: "解散组", selectGroupChildren: "全选组内节点", captureGroupNodes: "吸附框内节点", fitGroupContent: "自适应尺寸", groupedSuccess: "已将 {{count}} 个节点编组", ungroupedSuccess: "已解散组", capturedNodesSuccess: "已吸附 {{count}} 个框内节点入组", noNewNodesCaptured: "未发现新的框内节点", fitGroupSuccess: "已自适应调整组尺寸", noGroupChildren: "组内暂无子节点",
        },
        ...
        videoPlayer: { play: "播放", pause: "暂停", mute: "静音", unmute: "开启声音", preview: "大屏预览" },
        sidePanel: {
        ...
        projectPage: {
            stopTitle: "停止生成？", stopDescription: "当前生成请求会被中断，已经生成完成的内容会保留。", stop: "停止", continue: "继续生成", configConnection: "配置节点之间不能连接", notFound: "未找到当前画布", exporting: "正在导出当前画布…", exported: "已导出当前画布", clipboardText: "剪切板文本", clipboardImageAdded: "已从剪切板添加图片", clipboardTextAdded: "已从剪切板添加文本", noTextToSave: "没有可保存的文本", canvasText: "画布文本", noVideoToSave: "没有可保存的视频", canvasVideo: "画布视频", noImageToSave: "没有可保存的图片", canvasImage: "画布图片", emptyReverse: "图片节点为空，无法反推提示词", reverseTitle: "反推提示词", reverseConfigTitle: "反推提示词配置", splitTitle: "{{name}} {{row}}-{{column}}", splitSuccess: "已切分为 {{count}} 个子节点", maskResult: "局部编辑结果", maskFailed: "局部修改失败", generationFailed: "生成失败", partialFailed: "部分图片生成失败", partialTextFailed: "部分文本生成失败", allFailed: "全部图片生成失败", retryPromptMissing: "找不到提示词，无法重试", generationSnapshotMissing: "该结果缺少原始生成快照，无法再次生成", referenceMissing: "参考素材已丢失，无法继续生成", emptyTextImage: "文本节点为空，无法生图", untitledCanvas: "未命名画布", superResolve: "AI 超分", notImplemented: "暂未实现", imageDetails: "图片详情", videoDetails: "视频详情", clearTitle: "清空画布？", clear: "清空", clearDescription: "这会删除当前画布上的所有节点和连线。", reversePreset: "请根据参考图片反推一段适合用于 AI 生图的提示词。\n\n要求：\n1. 只输出提示词正文，不要解释。\n2. 覆盖主体、构图、风格、光线、色彩、材质、镜头和氛围。\n3. 尽量写成可直接用于生图模型的完整提示词。", maskPrompt: "只修改蒙版透明区域，其他区域保持不变。{{prompt}}"
        },
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", repeatGeneration: "再次生成", stop: "停止" },
        references: { title: "参考内容", select: "从画布选择参考节点", disconnect: "断开参考连接", empty: "暂无内容", selecting: "正在添加参考", choose: "选择", selectingHint: "从画布选择参考 · ESC 返回输入框", locateOrDrag: "点击定位节点，按住拖拽重排" },
    ...
    config: {
        ...
        channelEditor: {
            ...
            protocol: "协议",
            baseUrl: "接口地址",
            comfyuiProxyUrl: "ComfyUI 接口地址",
            comfyuiProxyToken: "Token / 访问凭据 (可选)",
            comfyuiProxyTokenPlaceholder: "直连原生 ComfyUI 可留空，或填入鉴权 Token",
            comfyuiProxyUrlError: "请填写 ComfyUI 接口地址，需以 http:// 或 https:// 开头",
            comfyuiProxyTokenError: "请填写 ComfyUI Token",
            models: "渠道模型",
            ...
            t2iWorkflowTitle: "文生图工作流 (T2I)",
            t2iWorkflowDesc: "在画布进行纯文字生成图片时调用此工作流。",
            i2iWorkflowTitle: "图生图工作流 (I2I)",
            i2iWorkflowDesc: "在画布连入参考图进行单图编辑、风格参考或多图融合时调用此工作流。",
            inpaintWorkflowTitle: "局部编辑工作流 (Inpaint)",
            inpaintWorkflowDesc: "在画布涂抹蒙版遮罩并点击「AI 修改」时调用此工作流。",
            textWorkflowTitle: "文本生成 / 反推工作流 (LLM)",
            textWorkflowDesc: "在画布进行文本生成或从图片反推提示词时调用此工作流。",
            videoWorkflowTitle: "全能参考视频工作流 (Video / Omni)",
    ...
    comfyui: {
        ...
        noWorkflow: "模型「{{model}}」尚未绑定 ComfyUI workflow，请先在「渠道」设置中为该模型上传 workflow JSON",
        noInpaintWorkflow: "当前 ComfyUI 渠道尚未配置局部编辑工作流，请先在「渠道」设置中上传局部编辑工作流 JSON",
        noTextWorkflow: "当前 ComfyUI 渠道尚未配置文本生成/反推工作流，请先在「渠道」设置中上传工作流 JSON",
        noVideoWorkflow: "当前 ComfyUI 渠道尚未配置全能参考视频生成工作流，请先在「渠道」设置中上传工作流 JSON",
        noFrameVideoWorkflow: "当前 ComfyUI 渠道尚未配置首尾帧视频生成工作流，请先在「渠道」设置中上传工作流 JSON",
    ...
    agent: {
        ...
        connect: { directTitle: "启动本地 Agent", directText: "在终端运行下面命令启动本地 Agent 服务，再回到网页连接或手动填入 Local URL 和 Connect token。", commandCopied: "命令已复制", copyCommand: "复制命令", title: "连接本地 Agent 与 WorkBuddy", description: "配置 WorkBuddy 桌面助理与本地 Agent 服务，实现双向智能协同。", webConnection: "本地 Agent 服务", autoDiscover: "负责桥接画布与 WorkBuddy 及本地工具，支持自动发现连接参数。", disconnect: "断开", connect: "连接", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
        ...
        eventMore: { toolRunning: "{{action}}中…", openedRoute: "已打开{{route}}", canvasCount: "共 {{count}} 个画布", promptCount: "找到 {{count}} 条提示词", assetCount: "共 {{count}} 个资产", assetAdded: "已加入我的素材", generationStatus: "共 {{total}} 个任务，排队 {{queued}}，运行中 {{running}}，成功 {{succeeded}}，失败 {{failed}}", workbenchExecuted: "已在工作台执行", workbenchConfigRead: "已读取工作台配置", canvasRead: "已读取当前画布内容", selectionRead: "已读取当前选中内容", textNodes: "{{count}} 个文本", imageNodes: "{{count}} 张图片", configNodes: "{{count}} 个配置", videoNodes: "{{count}} 个视频", audioNodes: "{{count}} 个音频", groupNodes: "{{count}} 个分组", otherNodes: "{{count}} 个其他节点", connections: "{{count}} 条连线", emptyCanvas: "当前画布为空", executeTool: "执行{{tool}}", thinking: "正在思考...", operationRunning: "{{operation}}正在进行...", organizingCanvas: "画布已读取，WorkBuddy 正在整理结果...", operationCompleted: "{{operation}}已完成，WorkBuddy 正在继续处理...", attachmentPrompt: "请处理上传的图片附件。", routes: { home: "首页", canvas: "画布页面", canvasProject: "指定画布", image: "生图工作台", video: "视频工作台", prompts: "提示词中心", assets: "我的素材", config: "配置页面" } },
        runtime: {
            mcpStarting: "正在启动 MCP：{{name}}", mcpConnecting: "正在建立工具连接并读取可用工具列表", mcpReadyNamed: "MCP 已就绪：{{name}}", toolsReady: "工具列表加载完成，可以开始对话", mcpFailedNamed: "MCP 启动失败：{{name}}", mcpCanceledNamed: "MCP 启动已取消：{{name}}", toolInitFailed: "工具服务未能完成初始化", mcpServicesStarting: "正在启动 MCP 服务", toolServicesPending: "还有 {{count}} 个工具服务正在初始化", checkingToolServices: "正在确认工具服务状态", conversationInitializing: "正在初始化对话", conversationCreating: "正在创建会话并启动画布工具服务", someMcpFailed: "部分 MCP 服务初始化失败", remainingToolsReady: "其余工具已就绪，可以开始对话", conversationInitFailed: "对话初始化失败", conversationCreateFailed: "无法创建会话", mcpServicesReady: "{{count}} 个 MCP 服务已完成初始化", toolInitCanceled: "工具服务初始化已取消", mcpStatusComplete: "MCP 状态确认完成", mcpListRead: "已读取返回的完整工具服务清单",
            historyReadFailed: "读取历史失败", conversationSyncFailed: "同步会话失败", agentOutdated: "本地 Agent 版本过旧，请重启 Canvas Agent 后重新连接", restartRequired: "需要重启 Agent", versionMismatch: "Agent 版本不匹配", awaitingApproval: "等待权限确认", codexRunning: "WorkBuddy 正在运行", connected: "已连接", localAgentConnected: "本地 Agent 已连接", processingFailed: "处理失败", completed: "完成", approvalGranted: "已批准权限", approvalCanceled: "已取消权限", log: "日志", connectionLostDescription: "本地 Agent 连接失败或已断开", connectionFailedDescription: "连接失败，请检查地址和 token", connectionLost: "连接断开", connectionFailed: "连接失败", modelListFailed: "读取模型列表失败",
