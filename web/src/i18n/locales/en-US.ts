export default {
    ...
    canvas: {
        ...
        zoom: "Zoom canvas",
        agentConnected: "WorkBuddy connected",
        agentConnecting: "WorkBuddy {{activity}}",
        agentDisconnected: "WorkBuddy disconnected",
        connecting: "Connecting",
        openAgent: "Open WorkBuddy panel",
        ...
        node: {
            node: "Node",
            untitled: "Untitled node", renameHint: "Double-click to rename the node", group: "Group", nodeCount: "{{count}} nodes", generating: "Generating", failed: "Generation failed", retry: "Retry", resumePolling: "Check status again", missingPlugin: "Plugin missing", missingPluginDescription: "The plugin for node type “{{type}}” is not installed or enabled", generateImage: "Generate image from text", generate: "Generate", editText: "Double-click to edit text", emptyImage: "Empty image node", emptyVideo: "Empty video node", emptyAudio: "Empty audio node", audio: "Audio", batchExpanded: "Image group expanded", batchCollapsed: "Image group collapsed", textBatchExpanded: "Text alternatives expanded", textBatchCollapsed: "Text alternatives collapsed", createCopy: "Create copy", setPrimary: "Set as primary", setPrimaryText: "Set as primary", groupSelection: "Group", ungroup: "Ungroup", selectGroupChildren: "Select All in Group", captureGroupNodes: "Capture Enclosed Nodes", fitGroupContent: "Fit to Content", groupedSuccess: "Grouped {{count}} nodes", ungroupedSuccess: "Ungrouped", capturedNodesSuccess: "Captured {{count}} nodes into group", noNewNodesCaptured: "No new enclosed nodes found", fitGroupSuccess: "Fit group to content", noGroupChildren: "No children in group",
        },
        ...
        videoPlayer: { play: "Play", pause: "Pause", mute: "Mute", unmute: "Unmute", preview: "Preview" },
        sidePanel: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", viewVideo: "View video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", repeatGeneration: "Generate again", stop: "Stop" },
        references: { title: "References", select: "Select references from canvas", disconnect: "Disconnect reference", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references from canvas · ESC to return", locateOrDrag: "Click to locate node, drag to reorder" },
    ...
    topNav: {
        ...
        credit: "Open Source:",
        creditRepo: "ZhuYichuan/infinite-canvas",
    },
    home: {
        heroTitle: "ComfyUI Infinite Canvas",
    ...
    config: {
        ...
        channelEditor: {
            ...
            comfyuiProxyUrl: "ComfyUI API URL",
            comfyuiProxyToken: "Token / Credentials (Optional)",
            comfyuiProxyTokenPlaceholder: "Optional for direct native ComfyUI connection",
            comfyuiProxyUrlError: "Enter the ComfyUI API URL (must start with http:// or https://)",
            comfyuiProxyTokenError: "Enter the ComfyUI token",
            ...
            t2iWorkflowTitle: "Text-to-Image Workflow (T2I)",
            t2iWorkflowDesc: "Invoked when generating images purely from text prompts on canvas.",
            i2iWorkflowTitle: "Image-to-Image Workflow (I2I)",
            i2iWorkflowDesc: "Invoked when connecting reference images for single-image editing or multi-image fusion on canvas.",
            inpaintWorkflowTitle: "Inpaint Workflow (Local Edit)",
            inpaintWorkflowDesc: "Invoked when painting a mask on the canvas and clicking Edit with AI.",
            textWorkflowTitle: "Text Generation / Reverse Prompt Workflow (LLM)",
            textWorkflowDesc: "Invoked when generating text or inferring reverse prompts from images on canvas.",
            videoWorkflowTitle: "Video Generation Workflow (Video / Omni)",
    ...
    comfyui: {
        ...
        defaultBuiltin: "Built-in",
        customWorkflow: "Custom",
        noWorkflowAttached: "No workflow attached",
        noWorkflow: "Model \"{{model}}\" has no ComfyUI workflow attached. Please upload a workflow JSON in Channel settings.",
        noInpaintWorkflow: "The current ComfyUI channel has no inpaint workflow configured. Please upload an inpaint workflow JSON in Channel settings.",
        noTextWorkflow: "The current ComfyUI channel has no text generation/inversion workflow configured. Please upload a workflow JSON in Channel settings.",
        noVideoWorkflow: "The current ComfyUI channel has no omni reference video workflow configured. Please upload a video workflow JSON in Channel settings.",
        noFrameVideoWorkflow: "The current ComfyUI channel has no frame video workflow configured. Please upload a frame video workflow JSON in Channel settings.",
    ...
    agent: {
        ...
        connect: { directTitle: "Run local Agent", directText: "Run the command below in a terminal to start the local Agent service, then return here to connect or enter the Local URL and Connect token manually.", commandCopied: "Command copied", copyCommand: "Copy command", title: "Connect local Agent & WorkBuddy", description: "Configure WorkBuddy desktop assistant and local Agent service for intelligent synergy.", webConnection: "Local Agent Service", autoDiscover: "Bridges the canvas with WorkBuddy and local tools with auto-discovery.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
        ...
        eventMore: { toolRunning: "{{action}}…", openedRoute: "Opened {{route}}", canvasCount: "{{count}} canvases", promptCount: "Found {{count}} prompts", assetCount: "{{count}} assets", assetAdded: "Added to My Assets", generationStatus: "{{total}} tasks: {{queued}} queued, {{running}} running, {{succeeded}} succeeded, {{failed}} failed", workbenchExecuted: "Executed in the workbench", workbenchConfigRead: "Workbench configuration read", canvasRead: "Current canvas read", selectionRead: "Current selection read", textNodes: "{{count}} text nodes", imageNodes: "{{count}} images", configNodes: "{{count}} config nodes", videoNodes: "{{count}} videos", audioNodes: "{{count}} audio nodes", groupNodes: "{{count}} groups", otherNodes: "{{count}} other nodes", connections: "{{count}} connections", emptyCanvas: "The canvas is empty", executeTool: "Run {{tool}}", thinking: "Thinking...", operationRunning: "{{operation}} is running...", organizingCanvas: "Canvas read; WorkBuddy is organizing the result...", operationCompleted: "{{operation}} completed; WorkBuddy is continuing...", attachmentPrompt: "Please process the uploaded image attachments.", routes: { home: "Home", canvas: "Canvas", canvasProject: "Selected canvas", image: "Image Studio", video: "Video Studio", prompts: "Prompt Center", assets: "My Assets", config: "Settings" } },
        runtime: {
            mcpStarting: "Starting MCP: {{name}}", mcpConnecting: "Connecting tools and loading the available tool list", mcpReadyNamed: "MCP ready: {{name}}", toolsReady: "Tool list loaded. You can start chatting.", mcpFailedNamed: "MCP failed to start: {{name}}", mcpCanceledNamed: "MCP startup canceled: {{name}}", toolInitFailed: "The tool service could not finish initializing", mcpServicesStarting: "Starting MCP services", toolServicesPending: "{{count}} tool services are still initializing", checkingToolServices: "Checking tool service status", conversationInitializing: "Initializing the conversation", conversationCreating: "Creating the conversation and starting canvas tools", someMcpFailed: "Some MCP services failed to initialize", remainingToolsReady: "The remaining tools are ready. You can start chatting.", conversationInitFailed: "Conversation initialization failed", conversationCreateFailed: "Could not create the conversation", mcpServicesReady: "{{count}} MCP services initialized", toolInitCanceled: "Tool service initialization was canceled", mcpStatusComplete: "MCP status check completed", mcpListRead: "Loaded the complete tool service list returned by the assistant",
            historyReadFailed: "Failed to read history", conversationSyncFailed: "Failed to sync conversation", agentOutdated: "The local Agent is outdated. Restart Canvas Agent and reconnect.", restartRequired: "Agent restart required", versionMismatch: "Agent version mismatch", awaitingApproval: "Awaiting approval", codexRunning: "WorkBuddy is running", connected: "Connected", localAgentConnected: "Local Agent connected", processingFailed: "Processing failed", completed: "Completed", approvalGranted: "Permission approved", approvalCanceled: "Permission canceled", log: "Log", connectionLostDescription: "The local Agent connection failed or was interrupted", connectionFailedDescription: "Connection failed. Check the address and token.", connectionLost: "Connection lost", connectionFailed: "Connection failed", modelListFailed: "Failed to load model list",
