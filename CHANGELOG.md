...
+ [修复] 修复画布「组」节点无法组织框选各类节点的问题：选中节点后点击底栏「组」或快捷键 ⌘G / Ctrl+G 即可根据选区包围盒智能一键编组；移动组或缩放组边界时自动吸附框内节点与解绑移出节点；组节点悬浮工具栏与右键菜单新增「全选组内节点」「吸附框内节点」「自适应尺寸」与「解散组（⇧⌘G）」功能；双击组节点快速全选组内成员。
