...
+ [调整] 部署方案与定价页面全面升级为三阶梯服务模型：设「极速自助体验包（¥19.9 一次性买断，分摊百 G 镜像存储成本，纯文档自查，遇报错请完全自行排查）」、主推「创作者年度伴学包（¥79/年，含持续镜像与工作流维护、优先答疑）」与「1对1 专家全包部署（¥299/次，远程代调优与不跑通全退承诺）」，同步更新横向全景对比表与常见 FAQ。
