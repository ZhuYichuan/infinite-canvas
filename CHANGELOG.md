...
+ [调整] 部署方案与定价页面全面细化服务边界与伴学权益：明确「极速自助体验包」仅限 AutoDL 云端镜像且自付算力租金；「创作者年度伴学包（¥79/年）」明确本地部署硬件要求（Win11/显存>12G 最佳）、增加硬件决定可用模型提示，交付内容精炼为持续升级服务与作者亲自优先微信答疑，同步更新横向全景对比表与 FAQ。
